        ...
        <>
            <section className="py-16 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl md:text-5xl font-bold text-center font-baskervville text-gray-900 dark:text-white mb-12">
                        Featured Artifacts
                    </h2>
                    ...
                    {isLoading ? (
                        ...
                        <div
                            className="flex flex-col justify-center items-center py-16 text-gray-900 dark:text-gray-100">
                            <AlertTriangle className="w-12 h-12 text-red-500 mb-4"/>
                            <h2 className="text-xl font-bold mb-2">Internal Server Error</h2>
                            <p className="text-gray-700 dark:text-gray-300 text-center">
                                Oops! We couldn't load featured artifacts. Please try again later.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p className="text-gray-700 dark:text-gray-300 text-center">No featured artifacts found</p>
                        </div>
                    ) : (
                        <motion.div
                        ...
                        >
                            {featuredArtifacts?.map((artifact) => (
                                <motion.div
                                    key={artifact._id}
                                    className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-shadow duration-300 hover:shadow-yellow-500/20"
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        <h3 className="text-xl font-semibold text-yellow-600 dark:text-yellow-500 mb-2">{artifact.name}</h3>
                                        <p className="text-gray-700 dark:text-gray-300 mb-4 line-clamp-2">{artifact.historicalContext}</p>
                                        <Button
